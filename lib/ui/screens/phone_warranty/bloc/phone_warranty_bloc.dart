...
class PhoneWarrantyBloc extends Bloc<PhoneWarrantyEvent, PhoneWarrantyState> {
  ...
  void openScaningPage(
      OpenScanningQrcodeEvent event, Emitter<PhoneWarrantyState> emit) async {
  ...
  Future<void> deleteItem(
      DeleteActiveCodeEvent event, Emitter<PhoneWarrantyState> emit) async {
    emit(LoadingState());
  ...
  Future<void> addItem(
      AddActivateCodeEvent event, Emitter<PhoneWarrantyState> emit) async {
    emit(LoadingState());
